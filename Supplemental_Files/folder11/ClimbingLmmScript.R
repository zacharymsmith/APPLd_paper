...
# ---------------------------- Configuration ---------------------------------
infile <- "combined_all_t2a_climbing.csv"   # columns: date, genotype, biological_rep, technical_rep, height
...
palette <- c(
  ...
  "APPLd"                  = "#FFFFB3",
  "CantonS"                = "#BEBADA",
  "CantonS;UAS-GAL4-RNAi"  = "#FB8072",
  "T2A (w1118 outcross)"   = "#80B1D3",
  "T2A;UAS-Appl"           = "#FDB462",
  "T2A;UAS-Cd4-TdTom"      = "#B3DE69",
  "T2A;UAS-GAL4-RNAi"      = "#FCCDE5",
  "w1118"                  = "#D9D9D9"
)
